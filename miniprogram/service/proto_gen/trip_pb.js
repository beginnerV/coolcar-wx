...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Trip = (function() {
         ...
         * @property {boolean|null} [isPromotionTrip] Trip isPromotionTrip
         * @property {boolean|null} [isFromGuestUser] Trip isFromGuestUser
         */
         ...
         * @member {boolean} isPromotionTrip
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.isPromotionTrip = false;

        /**
         * Trip isFromGuestUser.
         * @member {boolean} isFromGuestUser
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.isFromGuestUser = false;
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.isPromotionTrip != null)
                message.isPromotionTrip = Boolean(object.isPromotionTrip);
            if (object.isFromGuestUser != null)
                message.isFromGuestUser = Boolean(object.isFromGuestUser);
            return message;
        };
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.isPromotionTrip = false;
                object.isFromGuestUser = false;
            }
            ...
            if (message.isPromotionTrip != null && message.hasOwnProperty("isPromotionTrip"))
                object.isPromotionTrip = message.isPromotionTrip;
            if (message.isFromGuestUser != null && message.hasOwnProperty("isFromGuestUser"))
                object.isFromGuestUser = message.isFromGuestUser;
            return object;
        };
